...
import clydeImage from "../../Resources/Clyde.jpg";
import clydeResume from "../../Resources/Clyde_Clark_Resume.pdf"
        ...
        <div>
            ...
            <div class="container">
                <div class="image-wrapper float-left pr-3">
                    <img width="300px" src={clydeImage} alt="Clyde"/>
                </div>
                <div class="single-post-content-wrapper p-3">
                        ...
                        <p>Access my <a href={clydeResume}>Resume</a></p>
                </div>
            </div>
